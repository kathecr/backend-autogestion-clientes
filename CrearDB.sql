CREATE TABLE Usuario(
	usuario_id 			NUMERIC GENERATED BY DEFAULT ON NULL AS IDENTITY,
    nombre_usuario		VARCHAR(15) 	NOT NULL,
    clave 				VARCHAR(60) 	NOT NULL,
    rol					VARCHAR(10)		NOT NULL,
    PRIMARY KEY			(usuario_id),
    CONSTRAINT usuario_unique UNIQUE (nombre_usuario)
);
...
CREATE TABLE Empresa(
    ...
    CONSTRAINT empresa_unique UNIQUE (nit, correo)
);
...
CREATE TABLE Tutorial(
    ...
    calificacion 			FLOAT			,
    numero_calificaciones	NUMBER(10)		,
...
CREATE TABLE MetricasXTutorial(
	...
	calificacion 			NUMBER(1,2) 	NOT NULL,
